    ...
    def execute(self, args, action):
        try:
            ...
            # region Tables
                ...
                tmp = self.structure.extractRangeTable(
                    args[0], args[1], int(args[2]), args[3], args[4])
                print("Data from " + args[0] + "\\" + args[1] +
                      " with range " + args[3] + " - " + args[4])
                print(tmp)
                return tmp
            ...
            # region Tuples
                ...
                tmp = self.structure.extractRow(
                    args[0], args[1], list(map(int, args[2].split(','))))
